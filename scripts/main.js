; (function (window) {
  ...
  texts = [
    ...
    "世界很暗", "然后你来了 带着星星",
    "月亮有星星", "乌云有雨", "而你有我",
    "你是晚夏遗留在", "深海里的星星", "想把我所有的温柔", "都碾碎了撒给你",
    "星星醉酒到处跑", "月亮跌进深海里",
    "我以前从未觉得人间美好", "直到你来了",
    "星河满目琳琅", "可你是逆着风跑的星光",
  ...
  class Particle {
    ...
    draw(ctx) {
      if (textIndex <= 2) {
        ...
        ctx.fillStyle = 'rgba(91,225,176, ' + this.opacity + ')'
      } else if (textIndex <= 7) {
        ctx.fillStyle = 'rgba(225, 91, 100, ' + this.opacity + ')'
      } else if (textIndex <= 10) {
        ctx.fillStyle = 'rgba(99, 91, 225, ' + this.opacity + ')'
